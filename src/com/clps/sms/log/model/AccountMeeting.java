...
public class AccountMeeting implements Serializable{
	...
	private Integer am_created_id;//AM_CREATED_NAME
	...
	public AccountMeeting(Integer am_id, String am_name, String am_dec, Integer am_acc_id, Integer am_mee_id,
			String am_created_date, Integer am_created_id, String am_updated_date, Integer am_updated_name,
			Integer am_status) {
		super();
		this.am_id = am_id;
		...
		this.am_created_id = am_created_id;
	...
	public Integer getAm_created_name() {
		return am_created_id;
	}
	public void setAm_created_name(Integer am_created_id) {
		this.am_created_id = am_created_id;
	}
	...
	public String toString() {
		return "AccountMeeting [am_id=" + am_id + ", am_name=" + am_name + ", am_dec=" + am_dec + ", am_acc_id="
				...
				+ am_created_id + ", am_updated_date=" + am_updated_date + ", am_updated_name=" + am_updated_name
				+ ", am_status=" + am_status + "]";
	}
