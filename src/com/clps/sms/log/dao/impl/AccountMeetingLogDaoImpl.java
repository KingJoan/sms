...
public class AccountMeetingLogDaoImpl extends BaseDaoImpl<AccountMeetingLog> implements AccountMeetingLogDao {
	...
	private static final String HEAD="SELECT ACCOUNT_MEETING_LOG.AML_ID, ACCOUNT_MEETING_LOG.AML_ACTION, ACCOUNT_MEETING_LOG.AML_ACTION_CONTENT, ACCOUNT_MEETING_LOG.AML_CREATED_DATE, ACCOUNT_MEETING_LOG.AML_CREATED_ID, ACCOUNT_MEETING_LOG.AML_TYPE, ACCOUNT.ACC_NAME FROM ACCOUNT_MEETING_LOG , ACCOUNT WHERE ACCOUNT_MEETING_LOG.AML_CREATED_ID = ACCOUNT.ACC_ID ";
	...
	private static final String QUERYACCOUNTMEETINGLOGSBYCREATEDNAME=HEAD+"AND ACCOUNT_MEETING_LOG.AML_ACTION LIKE ? AND ACCOUNT_MEETING_LOG.AML_ACTION_CONTENT LIKE ? AND ACCOUNT_MEETING_LOG.AML_TYPE LIKE ? AND ACCOUNT.ACC_NAME = ? LIMIT ?,  ?";
	
	private static final String QUERYACCOUNTMEETINGLOGSBYCREATEDNAMEANDTIMERANGE=HEAD+"AND ACCOUNT_MEETING_LOG.AML_ACTION LIKE ? AND ACCOUNT_MEETING_LOG.AML_ACTION_CONTENT LIKE ? AND ACCOUNT_MEETING_LOG.AML_TYPE LIKE ? AND ACCOUNT.ACC_NAME = ? AND ACCOUNT_MEETING_LOG.AML_CREATED_DATE >= ? AND ACCOUNT_MEETING_LOG.AML_CREATED_DATE <= ? LIMIT ?,  ?";
	...
	@Override
	public List<AccountMeetingLog> queryAccountMeetingLogs(String aml_action, String aml_action_content,
			String aml_type, String aml_created_name, int begin, int num) {
		// TODO Auto-generated method stub
		Object[] parameter=new Object[]{
				"%"+aml_action+"%", 
				 "%"+aml_action_content+"%",   
	...
	@Override
	public List<AccountMeetingLog> queryAccountMeetingLogs(String aml_action, String aml_action_content,
			String aml_type, String aml_created_name, String start, String end, int begin, int num) {
		// TODO Auto-generated method stub
	Object[] parameter=new Object[]{
			 "%"+aml_action+"%",  
			 "%"+aml_action_content+"%",   
