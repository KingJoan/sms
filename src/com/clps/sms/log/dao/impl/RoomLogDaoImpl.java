...
public class RoomLogDaoImpl extends BaseDaoImpl<RoomLog> implements RoomLogDao {
	...
	private static final String HEAD="SELECT ROOM_LOG.RL_ID, ROOM_LOG.RL_ACTION, ROOM_LOG.RL_ACTION_CONTENT, ROOM_LOG.RL_CREATED_DATE, ROOM_LOG.RL_CREATED_ID, ROOM_LOG.RL_TYPE, ACCOUNT.ACC_NAME FROM ROOM_LOG , ACCOUNT WHERE ROOM_LOG.RL_CREATED_ID = ACCOUNT.ACC_ID ";
	...
	private static final String QUERYROOMLOGSBYTIMERANGE=HEAD+"AND ROOM_LOG.RL_ACTION LIKE ? AND ROOM_LOG.RL_ACTION_CONTENT LIKE ? AND ROOM_LOG.RL_TYPE LIKE ? AND ROOM_LOG.RL_CREATED_DATE >= ? AND ROOM_LOG.RL_CREATED_DATE <= ? LIMIT ?,  ?";
	
	private static final String QUERYROOMLOGSBYCREATEDNAME=HEAD+"AND ROOM_LOG.RL_ACTION LIKE ? AND ROOM_LOG.RL_ACTION_CONTENT LIKE ? AND ROOM_LOG.RL_TYPE LIKE ? AND ACCOUNT.ACC_NAME = ? LIMIT ?,  ?";
	
	private static final String QUERYROOMLOGSBYCREATEDNAMEANDTIMERANGE=HEAD+"AND ROOM_LOG.RL_ACTION LIKE ? AND ROOM_LOG.RL_ACTION_CONTENT LIKE ? AND ROOM_LOG.RL_TYPE LIKE ? AND ACCOUNT.ACC_NAME = ? AND ROOM_LOG.RL_CREATED_DATE >= ? AND ROOM_LOG.RL_CREATED_DATE <= ? LIMIT ?,  ?";
